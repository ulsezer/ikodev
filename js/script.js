...
const config = {
    serverInfo: {
        ...
        serverName: "𝐃𝐞𝐯𝐔𝐳™", /*Server name*/
        serverIp: "mc.devuz.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
